...
export function Footer() {
  return <footer className="footer"><div className="container-x footer-grid">
    <div className="footer-brand"><div className="brand"><span className="brand-mark"><ShieldCheck size={18}/></span><span>EDU<span>JUSTICE</span></span></div><p>An independent education transparency and student-rights platform. Report safely. Track securely. Demand fairness.</p><a href="mailto:contact@edujustice.org">contact@edujustice.org <ArrowUpRight size={14}/></a></div>
